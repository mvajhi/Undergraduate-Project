...
| `data/external/events.csv` | 2026-08-13 | `dc3af3fd46f2758e9613842b21c4d88ad7a9439328dac7d7d412b24be9702ad8` | ندارد (فایل دستی، بدون DVC — بند ۲-۴ WBS) | آرشیو خبری دستی رویدادهای بافتاری (۹ رویداد) در بازه‌ی قفل‌شده‌ی داده: ۶ بازی تیم‌ملی ایران در جام ملت‌های آسیا ۲۰۲۳ قطر، انتخابات مجلس/خبرگان ۱۱ اسفند ۱۴۰۲، یک تعطیلی اضطراری آلودگی هوا (۱۳ دی ۱۴۰۲) و یک اعتصاب رانندگان اتوبوسرانی تهران (۱۶ اسفند ۱۴۰۲)؛ منبع هر ردیف در ستون `source_url` همان فایل. **⚠️ طبق بند ۲-۴ WBS این فایل هرگز نباید فیچر یادگیری مدل شود** (هر رویداد یکتا فقط ۱ مشاهده در ۱۴۲ روز داده دارد ⇒ overfit قطعی)؛ نقش آن فقط توضیح داده‌های پرت در فاز ۴ است — جزئیات و محدودیت‌های روش پژوهش در `doc/decision_log.md` ردیف ۱۴ |
