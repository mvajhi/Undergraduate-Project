...
\begin{frame}{پ۶ — مدل برتر در برابر خط پایه، در نقطه‌ی سربه‌سر}
  \begin{itemize}
    \item در $\tau=0.20$ روی پنجره‌ی آزمون، مدل برتر از قوی‌ترین خط پایه (\lr{B3}) عملاً چیزی
      جلو نزد: $-0.011$ میلیارد تومان
...
\begin{frame}{«مدل پیچیده چه چیزی بیشتر از یک قاعده‌ی ساده داد؟»}
  ...
  \begin{itemize}
    \item در $\tau=0.20$ روی پنجره‌ی آزمون، مدل برتر از خط پایه‌ی \lr{B3} عملاً چیزی جلو نزد
      ($-0.011$ میلیارد)
