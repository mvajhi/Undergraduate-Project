...
def main() -> None:
    ...
    lines_104 = [
        ...
        "رشد/کاهش ثبت‌نام).",
        "4. **قیمت روز:** $C_o$=۳۷۵٬۰۰۰ تومان/پرس، نرخ امروز (شهریور ۱۴۰۵) — نه نرخ "
        "بازه‌ی داده (آذر ۱۴۰۲ تا خرداد ۱۴۰۳) که پایین‌تر بوده — و در طول سال تحصیلی "
        "ثابت فرض شده (بدون تورم).",
        ...
        "۹.۱ میلیارد تومان **در ۲۵ روز** داد (نه سالانه) — مقیاس این دو عدد قابل‌مقایسه "
