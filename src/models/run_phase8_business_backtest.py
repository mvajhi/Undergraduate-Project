...
**واحد ریالی:** فقط $C_o$≈۳۷۵ هزار تومان/پرس (بند ۲-۲ project-definition.md) — نرخ
امروز (شهریور ۱۴۰۵)، نه نرخ بازه‌ی داده که پایین‌تر بوده. $C_u$ (هزینه‌ی کمبود) هنوز تصمیم سیاستی تثبیت‌نشده است (همان سند)،
